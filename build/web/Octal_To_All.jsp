...
<html lang="en">
    ...
    <%
      try {    
          BigInteger decimal = new BigInteger(request.getParameter("octal"),8);
    ...
    <div class="container">
            <center><h1 class="well mainheading_style">Octal Number Conversion</h1></center>
	<div class="col-lg-12 well blue_color" >
	<div class="row">

            <div class="col-lg-6">
            
  <label class="col-lg-3 control-label heading_style" style="padding-top:20px; padding-bottom: 20">Octal No.</label>
