    ...
    <%@include file="header.html" %>
        <%@page contentType="text/html" pageEncoding="UTF-8"%>
            ...
            <body>
                <div class="container">
                    <center>
                        <h1 class="well mainheading_style">Enter Numbers for SELECTION SORT</h1>
                    </center>
                    <div class="col-lg-12 well blue_color">
                        <div class="row">
                            <form method="post" action="Selection_Sort.jsp">
                                <center>
                                    <div class="form-group">
                                        <br>
                                        <label class="col-md-2 control-label heading_style"><b>Enter Numbers</b></label>
                                        <div class="col-md-6">
                                            <input type="text" id="selection" name="selection" class="form-control" title="Only integers are allowed" required="">
