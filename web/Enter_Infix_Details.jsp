    ...
    <%@include file="header.html" %>
        <%@page contentType="text/html" pageEncoding="UTF-8"%>
            ...
            <body>
                <div class="container">
                    <center>
                        <h1 class="well mainheading_style">Enter INFIX EXPRESSION</h1>
                    </center>
                    <div class="col-lg-12 well blue_color">
                        <div class="row">
                            <form method="post" action="Infix_To_All.jsp">
                                <center>
                                    <div class="form-group">
                                        <br>
                                        <label class="col-md-2 control-label heading_style"><b>Infix Expression</b></label>
                                        <div class="col-md-3">
                                            <input type="text" id="infix" name="infix" class="form-control"  title="Only 0's and 1's are allowed" required="">
                                        </div><strong class="heading_style">Ex : A+(B*C-(D/E)*G)^H</strong><br><br>
                                </center>
                                <br><br><br>
                                <div class="col-lg-12">
