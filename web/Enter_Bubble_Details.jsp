    ...
    <%@include file="header.html" %>
        <%@page contentType="text/html" pageEncoding="UTF-8"%>
                                ...
                                for(i=0;i<bubble.length;i++)
                                 {
                                     ...
                                     if(valid.indexOf(ch)==-1)
                                     {
                                         ...
                                         document.getElementById("bubble").focus();
                                         return false;
                                     }    
                                 }   
                        }    
            ...
            <body>
                <div class="container">
                    <center>
                        <h1 class="well mainheading_style">Enter Numbers for BUBBLE SORT</h1>
                    </center>
                    <div class="col-lg-12 well blue_color">
                        <div class="row">
                            <form method="post" action="Bubble_Sort.jsp">
                                <center>
                                    <div class="form-group">
                                        <br>
                                        <label class="col-md-2 control-label heading_style"><b>Enter Numbers</b></label>
                                        <div class="col-md-6">
                                            <input type="text" id="bubble" name="bubble" class="form-control" title="Only integers are allowed" required="">
