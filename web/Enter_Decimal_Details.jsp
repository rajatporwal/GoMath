...
<html lang="en">
	...
	<body>
		<div class="container">
                    <center><h1 class="well mainheading_style">Enter Decimal Number</h1></center>
	<div class="col-lg-12 well blue_color" >
	<div class="row">
                 <form method="post" action="Decimal_To_All.jsp">
                                    <center>
                                        <div class="form-group">
                                            <br>        
                                            <label class="col-md-2 control-label heading_style" ><b>Decimal Number</b></label>
  <div class="col-md-3">
      <input type="text" id="decimal" name="decimal" class="form-control" maxlength="19" title="Only integers are allowed" required="" > 
