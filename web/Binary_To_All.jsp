...
<html lang="en">
    ...
    <%
      try {  
           ...
           BigInteger decimal = new BigInteger(request.getParameter("binary"), 2);
    ...
    <div class="container">
        <a href="header.html"></a>
            <center><h1 class="well mainheading_style">Binary Number Conversion</h1></center>
	<div class="col-lg-12 well blue_color" >
	<div class="row">

            <div class="col-lg-6">
            
  <label class="col-lg-3 control-label heading_style" style="padding-top:20px; padding-bottom: 20">Binary No.</label>
