...
<html lang="en">
    ...
    <%
      try {    
            BigInteger decimal = new  BigInteger(request.getParameter("hexadecimal"), 16);
    ...
    <div class="container">
            <center><h1 class="well mainheading_style">HexaDecimal Number Conversion</h1></center>
	<div class="col-lg-12 well blue_color" >
	<div class="row">

            <div class="col-lg-6">
            
  <label class="col-lg-3 control-label heading_style" style="padding-top:20px; padding-bottom: 20">HexaDecimal Number</label>
  <div class="col-lg-8" style="padding-top:20px; padding-bottom: 20">
      <input type="text" value="<%=hexadecimal%>" class="form-control text_style" readonly>
            ...
            <div class="col-lg-6">
  <label class="col-lg-4 control-label heading_style" style="padding-top:20px; padding-bottom: 20" >Decimal No.</label>
  <div class="col-lg-8" style="padding-top:20px; padding-bottom: 20">
